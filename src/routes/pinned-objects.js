...
pinnedObjectsRouter.get("/", requireAuth, async (req, res) => {
...
pinnedObjectsRouter.post("/:objectId", requireAuth, async (req, res) => {
  await pool.query(
...
pinnedObjectsRouter.delete("/:objectId", requireAuth, async (req, res) => {
