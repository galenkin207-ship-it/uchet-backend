...
hiddenObjectsRouter.get("/", requireAuth, async (req, res) => {
...
hiddenObjectsRouter.post("/:objectId", requireAuth, async (req, res) => {
  await pool.query(
...
hiddenObjectsRouter.delete("/:objectId", requireAuth, async (req, res) => {
